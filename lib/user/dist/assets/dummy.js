...
;define("dummy/components/user-table", ["exports", "user/components/user-table"], function (_exports, _userTable) {
  "use strict";
...
;define("dummy/initializers/user-agent", ["exports", "ember-useragent/initializers/user-agent"], function (_exports, _userAgent) {
  "use strict";
...
;define("dummy/services/user-agent", ["exports", "ember-useragent/services/user-agent"], function (_exports, _userAgent) {
  "use strict";
...
;define("dummy/templates/index", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "LlYlrYyY",
    "block": "{\"symbols\":[],\"statements\":[[4,\"link-to\",null,[[\"route\"],[\"user\"]],{\"statements\":[[0,\"User\"]],\"parameters\":[]},null]],\"hasEval\":false}",
    "meta": {
...
;define("dummy/user/tests/addon.lint-test", [], function () {
  "use strict";

  QUnit.module('ESLint | addon');
  QUnit.test('addon/components/user-table.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'addon/components/user-table.js should pass ESLint\n\n');
  });
...
;define("dummy/user/tests/app.lint-test", [], function () {
  "use strict";

  QUnit.module('ESLint | app');
  QUnit.test('app/components/user-table.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'app/components/user-table.js should pass ESLint\n\n');
  });
});
;define("dummy/user/tests/templates.template.lint-test", [], function () {
  "use strict";
  ...
  QUnit.test('addon/templates/components/user-table.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'addon/templates/components/user-table.hbs should pass TemplateLint.\n\n');
  });
});
;
...
;
          if (!runningTests) {
            require("dummy/app")["default"].create({"name":"user","version":"DETACHED_HEAD"});
          }
