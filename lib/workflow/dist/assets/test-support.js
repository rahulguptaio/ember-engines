...
define("ember-froala-editor/test-support/helpers/fill-in-froala-editor", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.fillInFroalaEditor = fillInFroalaEditor;
  _exports.default = void 0;
  ...
  var _default = Ember.Test.registerAsyncHelper('fillInFroalaEditor', function (app, selector, html) {
    return fillInFroalaEditor(selector, html);
  });

  _exports.default = _default;

  function fillInFroalaEditor(_x, _x2) {
    return _fillInFroalaEditor.apply(this, arguments);
  }

  function _fillInFroalaEditor() {
    _fillInFroalaEditor = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(selector, html) {
      var element;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              element = (0, _testHelpers.find)("".concat(selector, " [contenteditable]"));
              ...
              throw "[contenteditable] DOM element not found within the selector '".concat(selector, "'. ") + "Try adding 'await settled();' in your test before and after using 'fillInFroalaEditor()'";

            case 3:
              html = Ember.String.isHTMLSafe(html) ? html.toString() : html;
              return _context.abrupt("return", (0, _testHelpers.fillIn)(element, html));
...
define("ember-froala-editor/test-support/helpers/get-in-froala-editor", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.getInFroalaEditor = getInFroalaEditor;
  _exports.default = void 0;

  var _default = Ember.Test.registerHelper('getInFroalaEditor', function (app, selector) {
    return getInFroalaEditor(selector);
  });

  _exports.default = _default;

  function getInFroalaEditor(selector) {
    var element = (0, _testHelpers.find)("".concat(selector, " [contenteditable]")) || (0, _testHelpers.find)(selector);

    if (element === null) {
      throw "getInFroalaEditor(): DOM element not found with the selector '".concat(selector, "'");
    }

    return element.innerHTML.trim();
  }
});
define("ember-froala-editor/test-support/index", ["exports", "ember-froala-editor/test-support/helpers/fill-in-froala-editor", "ember-froala-editor/test-support/helpers/get-in-froala-editor"], function (_exports, _fillInFroalaEditor, _getInFroalaEditor) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  Object.defineProperty(_exports, "fillInFroalaEditor", {
    enumerable: true,
    get: function get() {
      return _fillInFroalaEditor.fillInFroalaEditor;
    }
  });
  Object.defineProperty(_exports, "getInFroalaEditor", {
    enumerable: true,
    get: function get() {
      return _getInFroalaEditor.getInFroalaEditor;
    }
  });
});
