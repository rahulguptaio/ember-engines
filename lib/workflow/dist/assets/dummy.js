...
;define("dummy/components/froala-content", ["exports", "ember-froala-editor/components/froala-content"], function (_exports, _froalaContent) {
  "use strict";
...
;define("dummy/components/froala-editor", ["exports", "ember-froala-editor/components/froala-editor"], function (_exports, _froalaEditor) {
  "use strict";
...
;define("dummy/helpers/froala-arg", ["exports", "ember-froala-editor/helpers/froala-arg"], function (_exports, _froalaArg) {
  "use strict";
...
;define("dummy/helpers/froala-html", ["exports", "ember-froala-editor/helpers/froala-html"], function (_exports, _froalaHtml) {
  "use strict";
...
;define("dummy/helpers/froala-method", ["exports", "ember-froala-editor/helpers/froala-method"], function (_exports, _froalaMethod) {
  "use strict";
...
;define("dummy/templates/components/froala-content", ["exports", "ember-froala-editor/templates/components/froala-content"], function (_exports, _froalaContent) {
  "use strict";
...
;define("dummy/templates/components/froala-editor", ["exports", "ember-froala-editor/templates/components/froala-editor"], function (_exports, _froalaEditor) {
  "use strict";
...
;define("dummy/templates/index", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "X4VGIBYt",
    "block": "{\"symbols\":[],\"statements\":[[4,\"link-to\",null,[[\"route\"],[\"workflow\"]],{\"statements\":[[0,\"Workflow\"]],\"parameters\":[]},null]],\"hasEval\":false}",
    "meta": {
...
;define("dummy/workflow/tests/addon.lint-test", [], function () {
  "use strict";
...
;define("dummy/workflow/tests/templates.template.lint-test", [], function () {
  "use strict";
...
;
          if (!runningTests) {
            require("dummy/app")["default"].create({"name":"workflow","version":"DETACHED_HEAD"});
          }
